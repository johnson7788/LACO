...
class BertModel(object):
  ...
  def __init__(self,
    ...
    with tf.compat.v1.variable_scope(name_or_scope='bert', default_name="bert",reuse=True):
      with tf.compat.v1.variable_scope(name_or_scope="embeddings",reuse=tf.compat.v1.AUTO_REUSE):
      ...
      with tf.compat.v1.variable_scope(name_or_scope="encoder",reuse=tf.compat.v1.AUTO_REUSE):
      ...
      with tf.compat.v1.variable_scope(name_or_scope="pooler",reuse=tf.compat.v1.AUTO_REUSE):
